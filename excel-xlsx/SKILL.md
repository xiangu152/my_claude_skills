---
name: excel-xlsx
description: "Create, inspect, and edit Microsoft Excel workbooks and XLSX files with reliable formulas, dates, types, formatting, recalculation, and template preservation. Use when (1) the task is about Excel, `.xlsx`, `.xlsm`, `.xls`, `.csv`, or `.tsv`; (2) formulas, formatting, workbook structure, or compatibility matter; (3) the file must stay reliable after edits. NOT for: plain text data dumps, CSV-only workflows, or when pandas alone suffices."
---

# Excel / XLSX

Create, inspect, and edit Microsoft Excel workbooks with reliable formulas, dates, formatting, and template preservation.
