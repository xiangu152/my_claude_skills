---
name: agent-browser
description: Headless browser automation CLI optimized for AI agents with accessibility tree snapshots and ref-based element selection. Use when automating multi-step web workflows, scraping structured data, or testing SPAs. NOT for: simple one-off page fetches (use curl/fetch), screenshot analysis, or when the user just needs to read a webpage.
---
...
## Why Use This Over Simple Fetching
...
- Just reading a webpage (curl/wget)
